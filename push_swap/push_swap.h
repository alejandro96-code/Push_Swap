...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/19 18:11:03 by alejanr2          #+#    #+#             */
/*   Updated: 2025/02/19 18:11:04 by alejanr2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_node				*get_last_and_second_last(t_stack *stack,
						t_node **second_last);
...
void				split_into_chunks(t_stack **a, t_stack **b, int min,
						int max);
